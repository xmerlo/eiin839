...
CallAllStations()
        {
            ...
            try
            {
                ...
                foreach (T station in stations)
                {
                    ...
                    //24h
                    Set(station.ToString(), station, 216000);
                }
            }
            catch
            {
        ...
        /*private async void SearchStation(string CacheItem)
        {
        ...
        public async Task<List<T>> GetAllStationsAsync()
        {
